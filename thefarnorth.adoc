...
The party moves back to the basket with the kobolts, and drop them in it to assess its resistance. Eggo pulls the rope, and it seems resistant enough. Eggo goes in the bucket first. The rest of the party does the same.
