...
Three mage hands raise up, with daggers in them. They float up twenty feet away to the darkness, approaching the kobolts. The hands start cutting the ropes. it takes two a re three cuts, and the kobolts drop free. The scream and try to grab on ropes and everything that they find. Two of them disappear in the darkness, one miracously manages to catch a peg in the scaffolding and escapes the fall.
